...
const Body = React.forwardRef(({ className = 'card-body', ...otherProps }, ref) =>
  useElement(otherProps, ref, 'card-body')
);
...
const Footer = React.forwardRef(({ className = 'card-footer', ...otherProps }, ref) =>
  useElement(otherProps, ref, className)
);

const Header = React.forwardRef((props, ref) => {
  const { hasBackground, className = 'card-header', ...otherProps } = props;
  return useElement(otherProps, ref, className, { gray: hasBackground });
});
...
const OverlayTitle = React.forwardRef(({ className = 'overlay-title', ...otherProps }, ref) =>
  useElement(otherProps, ref, className)
);

const Row = React.forwardRef(({ className = 'card-row', ...otherProps }, ref) =>
  useElement(otherProps, ref, className)
);
