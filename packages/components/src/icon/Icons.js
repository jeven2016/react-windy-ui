...
const useIcon = (props) => {
  ...
  const { className = 'svg icon', size = 'medium', extraClassName, ...otherProps } = props;

  //check size: large, medium, small
  validate(IconSize.includes(size), 'The size should be one of large/medium/small');
...
export const IconRadioChecked = React.forwardRef((props, ref) => {
  ...
  return (
    <svg
      ...
      {...otherProps}>
      <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z" />
      <Spring from={{ number: 0 }} to={{ number: 5 }}>
