...
function DocCenter(props) {
  ...
  const [store] = useState(() => initStore({ list: [] }) /**{list:  [{id: xx, text: xxx}]} **/);
  ...
  return (
    <QuickManuContext.Provider value={{ quickManuStore: store }}>
      <HomeHeader />
      <div style={containerStyle}>
        {!isMinLg && (
          ...
          >
            <DocMenu hasBox={false} onSelectMenuItem={selectMenuItem} />
          </Drawer>
        )}
