  ...
  return (
    <>
      <div className="doc doc-row">
        <Toggle active={hasTitle} onChange={(val) => set(val)} label="With title" />
      </div>
      <div className="doc doc-row">
        <Toggle active={hasFooter} onChange={(val) => enableFooter(val)} label="With footer" />
      </div>
      <div className="doc doc-row">
        <Toggle active={disabled} onChange={(val) => setDisabled(val)} label="Disabled" />
      </div>
      <div className="doc doc-row">
        <Toggle active={readonly} onChange={(val) => setReadonly(val)} label="Readonly" />
      </div>
      <div className="doc doc-row">
        <Toggle
          active={chinese}
          onChange={(val) => setChinese(val)}
