...
const createPopover = (text, position, activeBy) => {
  const body = (
    <span>
      I wanna show you what the popover component looks like and then you can consider if you can
      rely on it to represent a good page for your customers.
    </span>
  );
  return (
    <Popover body={body} activeBy={'hover'} position={position} hasBorder={true} hasBox={false}>
      <Button
        hasMinWidth={false}
        color="primary"
        outline
