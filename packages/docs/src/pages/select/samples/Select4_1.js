  ...
  return (
    <>
      ...
      <div className="doc doc-row space">
        <Select defaultValue="a" onSelect={(value) => console.log(value)}>
      ...
      <div className="doc doc-row space">
        <Select defaultValue="a" hasArrow={false} onSelect={(value) => console.log(value)}>
      ...
      <div className="doc doc-row space">
        <Select defaultValue="a" onSelect={(value) => console.log(value)}>
          <Select.Option
            value="a"
            render={() => <Template2 title="Laptop" icon={<FontAwesomeIcon icon={faLaptop} />} />}
          >
            <Template
              title="Laptop"
              desc="$500 (On Sale)"
          ...
          <Select.Option
            value="b"
            render={() => <Template2 title="Phone" icon={<FontAwesomeIcon icon={faMobileAlt} />} />}
          >
            <Template
              title="Phone"
              desc="$300 (On Sale)"
          ...
          <Select.Option
            value="c"
            render={() => <Template2 title="Car" icon={<FontAwesomeIcon icon={faCar} />} />}
          >
            <Template
              title="Car"
              desc="$50,000 (On Sale)"
