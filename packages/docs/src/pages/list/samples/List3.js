    ...
    <div className="doc doc-row">
      <List>
        <List.Item
          ...
          actions={[<Button inverted hasBox={false}><FontAwesomeIcon icon={faPhone}/></Button>,
            <Button inverted hasBox={false}><FontAwesomeIcon icon={faCog}/></Button>
          ]}
        />
        <Divider/>
        <List.Item
          type="panel"
          icon={<Avatar hasBox={false} size="small" extraClassName="bg-color-green">W</Avatar>}
          title="Wang"
          description="The description for this person"
          actions={[<Button inverted hasBox={false}><FontAwesomeIcon icon={faPhone}/></Button>,
            <Button inverted hasBox={false}><FontAwesomeIcon icon={faCog}/></Button>
