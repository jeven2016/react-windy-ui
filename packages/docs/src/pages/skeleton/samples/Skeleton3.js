  ...
  return loading ? (
    ...
    <Card style={{ width: '20rem' }}>
      <Card.CardImage autoScale>
        <Card.Image src={pic} style={{ height: '150px' }}></Card.Image>
      </Card.CardImage>
      <Card.Body>
        <List>
          <List.Item
            ...
            type="panel"
            icon={
              <Avatar hasBox={false} extraClassName="bg-color-green">
                B
              </Avatar>
            }
            title={<h5>Wang</h5>}
  ...
  return (
    <>
      <div className="doc doc-row">
        <Toggle active={loading} onChange={(val) => setLoading(val)} label="Loading" />
      </div>
