...
export default function Menu10() {
  ...
  return (
    <div style={{ width: horizontal ? '100%' : '50%' }}>
      ...
      <div className="doc doc-row">
        <Toggle
          active={horizontal}
          onChange={(active) => setHorizontal(active)}
          label="Horizontal"
        />
      </div>
      <div className="doc doc-row">
        <Toggle
          active={popupSubMenu}
          onChange={(active) => setPopupSubMenu(active)}
          label="Pop SubMenu"
        />
      </div>
        ...
        >
          ...
          >
            ...
            <Menu.Group header="Group2">
              ...
              <Menu.Item id="item4">Item4</Menu.Item>
            </Menu.Group>
            <Menu.SubMenu header="SubMenu" id="sub1_child">
              <Menu.Item id="sub_item1">SubMenu Item1</Menu.Item>
              <Menu.Item id="sub_item2">SubMenu Item2</Menu.Item>
              <Menu.Item id="sub_item3">SubMenu Item3</Menu.Item>
            </Menu.SubMenu>
          </Menu.SubMenu>
          <Menu.SubMenu
            ...
            icon={<FontAwesomeIcon icon={faLaptop} />}
          >
            <Menu.Item id="item5">Item5</Menu.Item>
            <Menu.Item id="item6">Item6</Menu.Item>
