...
export default function Notification7() {
  ...
  const sendMessage = () => {
    Notification.simple('This is a message. duration=' + Notification.getConfig().duration);
  };

  return (
    <>
      <div className="doc doc-row">
        <Toggle defaultActive={true} onChange={(active) => toggle(active)} label="Auto close" />
      </div>
