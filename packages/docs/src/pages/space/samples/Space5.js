...
export default function Space5() {
  ...
  return <>
    <div className="doc doc-row">
      <Toggle defaultActive={block} onChange={active => setBlock(active)}
              label='block'/>
      <Toggle defaultActive={blockItem} onChange={active => setBlockItem(active)}
              label='blockItem'/>
    </div>
    <Space
      block={block}
      ...
      <Button color="red" hasOutlineBackground={false} outline
              invertedOutline
