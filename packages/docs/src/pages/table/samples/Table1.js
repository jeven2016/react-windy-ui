  ...
  return (
    <>
      <div className="doc doc-row">
        <Toggle active={hasBox} onChange={(val) => setBox(val)} label="Box Shadow" />
      </div>
      <div className="doc doc-row">
        <Toggle active={hover} onChange={(val) => setHover(val)} label="Hover" />
      </div>
      <div className="doc doc-row">
        <Toggle active={hasBorder} onChange={(val) => setBorder(val)} label="Border" />
      </div>
