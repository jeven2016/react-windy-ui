...
const CheckboxIndex = React.lazy(
  () => import( "../pages/checkbox/CheckboxIndex"));
const RadioIndex = React.lazy(() => import( "../pages/radio/RadioIndex"));
const ToggleIndex = React.lazy(() => import( "../pages/toggle/ToggleIndex"));
const CollapseIndex = React.lazy(
  () => import( "../pages/collapse/CollapseIndex"));
...
const NotificationIndex = React.lazy(
...
const ProgressIndex = React.lazy(
  () => import( "../pages/progress/ProgressIndex"));
...
const PaginationIndex = React.lazy(
  () => import( "../pages/pagination/PaginationIndex"));
const DatePickerIndex = React.lazy(
  () => import( "../pages/datepicker/DatePickerIndex"));
...
const TextFieldIndex = React.lazy(
  () => import( "../pages/text_field/TextFieldIndex"));
...
const SkeletonIndex = React.lazy(
  () => import( "../pages/skeleton/SkeletonIndex"));
const ContainerIndex = React.lazy(
  () => import( "../pages/container/ContainerIndex"));
const TypographyIndex = React.lazy(
  () => import( "../pages/typography/TypographyIndex"));
const StepperIndex = React.lazy(() => import( "../pages/stepper/StepperIndex"));
const BoxIndex = React.lazy(() => import( "../pages/box/BoxIndex"));
